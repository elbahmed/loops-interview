...
@section('endpoint', '/packages/edit')

@section('breadcrumb')
<li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
<li class="breadcrumb-item"><a href="/packages">Package</a></li>
<li class="breadcrumb-item active"><a href="/packages/edit">Edit</a></li>
@endsection
        ...
        <div class="card mb-3">
            ...
            <div class="card-body bg-light">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="packages__name" name="name" value="{{ $result->name }}">
                </div>
                <div class="mb-3">
                    <label class="form-label" for="packages__active-period">Masa Aktif</label>
                    <div class="input-group">
                        <input type="number" class="form-control" id="packages__active-period" name="active_period" min="1" max="1000" value="{{ $result->active_period }}" aria-describedby="basic-addon2"><span class="input-group-text" id="basic-addon2">Bulan</span>
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" id="packages__price" name="price" min="1000" value="{{ $result->price }}">
                    </div>
                </div>
            </div>
...
<script>
    $('#packages__btn').on('click', function(e) {
        ...
        if ($("#packages__form").parsley().isValid()) {
            ...
            sendPut('/packages/{{ $result->id }}', data);
        }
    });
</script>
@endsection
