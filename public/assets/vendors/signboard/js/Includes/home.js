...
function _typeof(e) {
            ...
            e = {
                ...
                updateSlides: function () {
                    var e = this,
                        ...
                        n = e.rtlTranslate,
                        H = e.wrongRTL,
                        N = ((h = e.virtual && t.virtual.enabled) ? e.virtual : e).slides.length,
                    ...
                    if (void 0 !== i) {
                        ...
                        for (var w, B, q, y, V, b = t.slidesPerColumn, X = w / b, F = Math.floor(r / t.slidesPerColumn), x = 0; x < r; x += 1) {
                            k = 0;
                        ...
                        0 === o.length && (o = [0]), 0 !== t.spaceBetween && (e.isHorizontal() ? n ? s.filter(c).css({
                        ...
                        }), q = (B -= t.spaceBetween) - i, o = o.map(function (e) {
                            return e < 0 ? -u : q < e ? q + p : e
                        })), t.centerInsufficientSlides && (y = 0, d.forEach(function (e) {
                            y += e + (t.spaceBetween || 0)
                        }), (y -= t.spaceBetween) < i && (V = (i - y) / 2, o.forEach(function (e, t) {
                            o[t] = e - V
                            ...
                            slidesGrid: l,
                            slidesSizesGrid: d
                        }), r !== N && e.emit("slidesLengthChange"), o.length !== h && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), l.length !== G && e.emit("slidesGridLengthChange"), (t.watchSlidesProgress || t.watchSlidesVisibility) && e.updateSlidesOffset()
                    }
                },
    ...
    function s() {
        var i = setInterval(function () {
            var e, t, a = new Date;
            for (e in d) d.hasOwnProperty.call(d, e) && (t = d[e], a.getHours() == parseInt(t.time.split(":")[0]) && a.getMinutes() == parseInt(t.time.split(":")[1] - 1) && (document.querySelector(".screen-will-adzan").classList.remove("hiden"), document.querySelector(".menjelang-adzan").innerHTML = t.name, document.querySelector(".saat-sholat").innerHTML = t.name, function (a) {
                var i = new Date,
                    n = (i.setHours(d[a].time.split(":")[0]), i.setMinutes(d[a].time.split(":")[1]), i.setSeconds(0), setInterval(function () {
                        ...
                        document.querySelector(".timer-countdown-adzan").innerHTML = t, e < 1 && (clearInterval(n), u(a))
                    }, 1e3))
            }(e), clearInterval(i)))
        }, 1e3)
    }
    ...
    var t, l, e, d, c = new XMLHttpRequest;
    c.onload = function () {
        t = this.responseText
    }, c.open("get", "/config/interval/iqama", !0), c.send(), (c = new XMLHttpRequest).onload = function () {
        e = this.responseText
    }, c.open("get", "/config/interval/prayer", !0), c.send(), (c = new XMLHttpRequest).onload = function () {
        l = this.responseText
    }, c.open("get", "/config/interval/lecture", !0), c.send();
    (c = new XMLHttpRequest).onload = function () {
        d = this.responseText
    }, c.open("get", "/data/prayer", !0), c.send(), setInterval(function () {
    ...
    var u = function (e) {
        ...
        var i = new Date,
            n = (i.setMinutes(i.getMinutes() + t), i.setSeconds(0), setInterval(function () {
                var e = (new Date).getTime(),
                    e = i.getTime() - e,
